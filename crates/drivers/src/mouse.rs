...
use core::sync::atomic::{AtomicI8, AtomicIsize, AtomicU64, AtomicU8, Ordering};
        ...
        if flags & 0xC0 == 0 {
            ...
            if mp.has_wheel {
                ...
                if scroll != 0 {
                    ...
                    crate::input::push_mouse_event(crate::input::REL_WHEEL, scroll as i32);
                }
            }
            ...
            if new_buttons != prev {
                if (new_buttons & 1) != (prev & 1) {
                    crate::input::push_mouse_button(0x110, new_buttons & 1 != 0);
                }
                if (new_buttons & 2) != (prev & 2) {
                    crate::input::push_mouse_button(0x111, new_buttons & 2 != 0);
                }
                if (new_buttons & 4) != (prev & 4) {
                    crate::input::push_mouse_button(0x112, new_buttons & 4 != 0);
                }
            ...
            if x_rel != 0 {
                crate::input::push_mouse_event(crate::input::REL_X, x_rel);
            }
            if y_rel != 0 {
                crate::input::push_mouse_event(crate::input::REL_Y, y_rel);
            }
            crate::input::sync_mouse();
        }
