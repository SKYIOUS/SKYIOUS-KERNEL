// SAFETY CONTRACT:
// Serial COM1 registers are at fixed I/O ports 0x3F8-0x3FF (standard
// x86 UART). All port access is direct I/O with no MMIO. Transmit checks
// LSR bit 5 (THRE) before writing. Receive checks LSR bit 0 (DR) before
// reading. Interrupt handler reads IIR to identify interrupt source.
