...
Write-Host "--- Booting SKYIOUS Kernel (display mode) ---" -ForegroundColor Cyan
qemu-system-x86_64 -bios $bios -drive format=raw,file=$img -m 512M -smp 2 -cpu max -serial file:serial.log
