...
impl Step for VirtAddr {
    fn forward_overflowing(start: Self, count: usize) -> (Self, bool) { (start + count as u64, false) }
    fn backward_overflowing(start: Self, count: usize) -> (Self, bool) { (start - count as u64, false) }
    #[inline]
