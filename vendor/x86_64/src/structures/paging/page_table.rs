...
impl Step for PageTableIndex {
    fn forward_overflowing(start: Self, count: usize) -> (Self, bool) { (PageTableIndex::new(start.0 + count as u16), false) }
    fn backward_overflowing(start: Self, count: usize) -> (Self, bool) { (PageTableIndex::new(start.0 - count as u16), false) }
    #[inline]
