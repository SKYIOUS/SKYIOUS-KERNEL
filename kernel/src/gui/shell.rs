...
use crate::gui::{drawing, SCREEN_HEIGHT, SCREEN_WIDTH};
...
pub const MENU_ITEMS: [&str; MENU_ITEM_COUNT] = [
    "File Manager",
    "Terminal",
    "System Monitor",
    "About",
...
pub const MENU_ICONS: [u32; MENU_ITEM_COUNT] = [
    0xFFFFD700, 0xFF00C853, 0xFFFF6F00, 0xFF7B1FA2, 0xFF2979FF, 0xFFD50000,
];
...
pub fn draw_start_menu(buffer: &mut [u32], mouse_x: usize, mouse_y: usize) {
    ...
    for (i, item) in MENU_ITEMS.iter().enumerate() {
        ...
        let hovered = mouse_x >= menu_x + 2
            && mouse_x < menu_x + menu_w - 2
            && mouse_y >= iy
            && mouse_y < iy + 34;
