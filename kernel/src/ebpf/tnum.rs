...
impl Tnum {
    ...
    pub fn or(self, rhs: Self) -> Self {
        Tnum {
            value: (self.value | rhs.value) & !(self.mask | rhs.mask),
    ...
    pub fn ashr(self, rhs: Self) -> Self {
        ...
        Tnum {
            value: (self.value as i64 >> rhs.value) as u64,
            mask: u64::MAX,
        }
    }
    ...
    pub fn could_be_nonzero(&self) -> bool {
        self.value != 0 || self.mask != 0
    }
    pub fn is_exact(&self) -> bool {
        self.mask == 0
    }
    pub fn is_subrange(&self, lo: u64, hi: u64) -> bool {
